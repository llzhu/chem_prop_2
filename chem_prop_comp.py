...
def app_header():
    ...
    with read_me_exp:
        ...
        st.markdown("""The data are from ChEMBL assay data with the following query.
                       activity.filter(target_chembl_id='CHEMBL204').filter(standard_type='IC50').filter(standard_relation='=')
